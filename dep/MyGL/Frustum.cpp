...
//http://www.cnblogs.com/dragon2012/p/3891519.html
	void Frustum::CalculatePlanes(const glm::mat4 &_mvp)
	{
		//
		...
		const float *mvp=glm::value_ptr(_mvp);
...
//http://www.crownandcutlass.com/features/technicaldetails/frustum.html
	...
	bool Frustum::PointInFrustum(const glm::vec3 &pos) const
	{
		return PointInFrustum(pos.x, pos.y, pos.z);
	}

	bool Frustum::SphereInFrustum(float x, float y, float z, float rad) const
	{
		int p;
		float d;
	...
	bool Frustum::SphereInFrustum(const glm::vec3 &pos, float rad) const
	{
	...
	bool Frustum::CubeInFrustum(const glm::vec3 &pos, float size) const
	{
